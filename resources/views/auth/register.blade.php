        ...
        <div class="col l6 m10 s10 offset-l3 offset-m1 offset-s1 z-depth-1 login-form">
            ...
            <div class="section">
                ...
                <form role="form" method="POST" action="{{ url('/register') }}">
                    ...
                    <div class="col s6{{ $errors->has('last_name') ? ' has-error' : '' }}">
                    ...
                    <div class="col s6{{ $errors->has('first_name') ? ' has-error' : '' }}">
                    ...
                    <div class="col s6{{ $errors->has('phone') ? ' has-error' : '' }}">
                    ...
                    <p class="col s6{{ $errors->has('gender') ? ' has-error' : '' }}">
                    ...
                    <div class="col s6{{ $errors->has('birthday') ? ' has-error' : '' }}">
