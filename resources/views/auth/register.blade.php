            ...
            <div class="col l10 m12 s12 offset-l1 card-panel">
                ...
                <div class="section">
                    ...
                    <form role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <p>En cliquant sur S'enregistrer, vous certifiez avoir 18 ans et plus et vous acceptez les <a href="{{ route('page', 'conditions' )}}">Conditions Générales d'Utilisation</a> de Usain Box.</p>
