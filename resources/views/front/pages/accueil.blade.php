...
@section('content')
    ...
    <div class="row header-search ">
        <form class=" col s12">
            <h3 class="col s12 white-text">Envoyez vos colis à temps réduit</h3>
            <div class="row">
                <div class="input-field col s3">
                    <input id="icon_prefix" class="white" placeholder="Ville départ" type="text" class="validate">
                ...
                <div class="input-field col s2">
                    <button class="col s12 btn waves-effect waves-light white black-text" type="button" name="action">Expédier
                    </button>
                </div>
                <div class="input-field col s2">
                    <button class="col s12 btn waves-effect waves-light white black-text" type="button" name="action">Transporter
                    </button>
                </div>
            </div>
        </form>
        <a id="scrollDown" href="#introduction" class=" waves-effect waves-light transparent white-text"><i class="material-icons">expand_more</i></a>
    </div>

    <div class="row valign-wrapper">
        <section id="introduction" class="center col s6 valign section scrollspy ">
            <h3 class="col s10 offset-s1">Lorem Ipsum</h3>
            <p class="col s10 offset-s1">Le Lorem Ipsum est simplement du faux texte employé dans la composition et
        ...
        <section class="col s6 home-img">
            {{ Html::image('public/img/img.png', 'Lorem Ipsum') }}
        </section>
    </div>
        ...
        <section class="col s12 valign-wrapper home-img" id="video-pres">
