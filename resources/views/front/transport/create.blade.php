    ...
    <div class="card col s12 l6">
        <form method="post" class="row card-content" action="{{route('post_create_transport_offer')}}">
                ...
                <div class="offer horizontal$selected" offer-id="$offerid">
                    <div class="card-stacked col s12">
                        <div class="section detail-steps " id="stepsArea">
                            ...
                            <div class="infoDepAnnonce" id="endstep" {{ $errors->has('end_city') ? ' has-error' : '' }} >
                                <label for="end_city">Ville d'arrivé <span class="obligatoire">*</span></label>
                                <input id="end_city" type="text" class="form-control step" name="end_city" value="{{ old('end_city') }}" draggable="true">
            ...
            <div class="col s12 m6 infoProfile infoDepAnnonce "{{ $errors->has('max_volume') ? ' has-error' : '' }}>
                ...
                <input id="max_volume" type="number" class="form-control" placeholder="Volume max en cm3" name="max_volume" value="{{ old('max_volume') }}">
