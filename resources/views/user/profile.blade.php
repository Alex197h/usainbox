        ...
        <div class="row card-panel">
            ...
            <div class="col s8">
                <div class="section">
                    ...
                    <p>
                        <span>Inscrit le {{ utf8_encode(strftime('%A %d %B %Y', strtotime($user->created_at))) }}</span>
                    </p>
                    <h5 class="col s9 m3">
                        {{
            ...
            <div class="col s8 m4">
                <div class="collection">
                    ...
                    <a class="collection-item" href="#vehicles">
                        Vos vehicule
                    </a>
                    <a class="collection-item" href="{{ route('my_bookings') }}">
                        Vos reservations
                        @if($reservations > 0)
                        <span class="new badge red">{{ $reservations }}</span>
                        @endif
                    </a>
                </div>
            </div>
        ...
        <div class="row card-panel">
            <div class="section">
                <h4>
                    Mes informations
                    {{
                        Html::image('public/img/user/signs.svg',
                        'Icon d\'une fusée',
                        array('class' => 'responsive-img icon', 'style' => 'vertical-align:middle;'))
                    }}
                </h4>
            </div>
            <div class="input-field infoProfile2 col s12 m6 {{ $errors->has('gender') ? ' has-error' : '' }}">
            ...
            <div class="input-field infoProfile2 col s12 m6{{ $errors->has('help_charge') ? ' has-error' : '' }}">
